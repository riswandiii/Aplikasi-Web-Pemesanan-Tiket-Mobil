...
<div class="container-fluid" id="container-fluid">
  ...
  <div class="row text-white text-center">
      <div class="col-lg-12 mt-5">
          <h3>DATA TABLE RUTE</h3>
      </div>
  </div>

  <div class="row mt-3 mb-4">
        <div class="col-lg-6 offset-lg-3">
            <a href="tambah.php" class="btn btn-primary btn-sm">Tambah Data Rute</a>
        </div>
    </div>
                ...
                <table class="table table-sm table-striped text-white table-bordered">
                    ...
                    <?php 
						...
						<tr>
                            ...
                            <td>
                                <a href="ubah.php?id_rute=<?php echo $row['id_rute']?>" class="btn btn-primary btn-sm">Edit</a> ||
                                <a href="hapus.php?id_rute=<?php echo $row['id_rute'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('YAKIN INGI HAPUS DATA?')">Delete</a>
                            </td>
                            
						</tr>
						<?php }}else{ ?>
							<tr>
								<td colspan="8" class="text-white">Belom Ada Rute</td>
							</tr>
